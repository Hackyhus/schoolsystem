...
export function InvoiceTemplate({ invoice }: InvoiceTemplateProps) {
  ...
  return (
    <div style={{ width: '8.27in' }}>
        <Card className="invoice-container w-full mx-auto my-8 p-4 shadow-lg print:shadow-none print:border-0 break-inside-avoid bg-white text-black dark:bg-white">
