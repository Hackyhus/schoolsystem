...
import type { Announcement as AnnouncementType } from '@/lib/schema';
...
export default function AnnouncementsPage() {
    ...
    const fetchAnnouncements = useCallback(async () => {
        setIsLoading(true);
        try {
            const fetchedAnnouncements = await dbService.getDocs<AnnouncementType>('announcements', [{ type: 'orderBy', fieldPath: 'createdAt', direction: 'desc' }]);
    ...
    const handleEdit = (ann: AnnouncementType) => {
