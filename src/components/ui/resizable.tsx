...
import { Panel as PanelPrimitive, PanelResizeHandle as PanelResizeHandlePrimitive } from "react-resizable-panels"
...
const ResizableHandle = forwardRef<
  ...
  ComponentProps<typeof PanelResizeHandlePrimitive> & { withHandle?: boolean }
